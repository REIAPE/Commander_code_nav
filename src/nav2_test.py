...
def apartments_circulation_order():
    apartments = 'Asuinhuoneisto 5', 'Siivouskomero', 'Varasto','Asuinhuoneisto 6','Asuinhuoneisto 8','Asuinhuoneisto 7','Asuinhuoneisto 10', 'Asuinhuoneisto 9', 'Asuinhuoneisto 12', 'Asuinhuoneisto 10'
    return apartments
